...
#                     lower_bound = torch.clamp(x - self.eps, min=-1., max=1.)
#                     upper_bound = torch.clamp(x + self.eps, min=-1., max=1.)
#                     x_adv_1 = torch.where(x_adv_1 > lower_bound, x_adv_1, lower_bound)
#                     x_adv_1 = torch.where(x_adv_1 < upper_bound, x_adv_1, upper_bound)
